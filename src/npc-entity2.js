...
export const npc_entity2 = (() => {
  ...
  class NPCFSM2 extends finite_state_machine.FiniteStateMachine {
    constructor(proxy) {
      super();
      this._proxy = proxy;
      this._Init();
  ...
  class NPCController2 extends entity.Component {
    constructor(params) {
      super();
      this._Init(params);
    }
    ...
    _Init(params) {
      ...
      // FIXME
      this._stateMachine = new NPCFSM2(
